...
mxBpmnShape.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  var bg = mxUtils.getValue(
    this.style,
    mxBpmnShape.prototype.miscEnum.BACKGROUND,
    mxBpmnShape.prototype.eventTypeEnum.NONE
  )
...
mxBpmnShape.prototype.redrawPath = function (c, x, y, w, h, layer) {
  ...
  if (layer == mxBpmnShape.prototype.miscEnum.BACKGROUND) {
    ...
    var o = mxUtils.getValue(
      this.style,
      mxBpmnShape.prototype.miscEnum.OUTLINE,
      mxBpmnShape.prototype.eventTypeEnum.NONE
    )
    ...
    if (s != null) {
      ...
      if (f != null) {
        ...
        if (s === 'star') {
          ...
          o === mxBpmnShape.prototype.eventTypeEnum.THROWING ||
          o === mxBpmnShape.prototype.eventTypeEnum.END
        ) {
...
mxShapeBpmnEvent.prototype.customProperties = [
  {
    ...
    enumList: [
      { val: mxShapeBpmnEvent.prototype.eventEnum.GENERAL, dispName: 'General' },
  ...
  },
  {
    ...
    enumList: [
      { val: mxShapeBpmnEvent.prototype.eventTypeEnum.START_STANDARD, dispName: 'Standard' },
      { val: mxShapeBpmnEvent.prototype.eventTypeEnum.EVENT_SP_INT, dispName: 'Interrupting' },
      {
        val: mxShapeBpmnEvent.prototype.eventTypeEnum.EVENT_SP_NONINT,
      ...
      {
        val: mxShapeBpmnEvent.prototype.eventTypeEnum.BOUND_NONINT,
...
mxShapeBpmnGateway.prototype.customProperties =
  mxShapeBpmnGateway.prototype.customProperties.concat({
    name: 'gwType',
    dispName: 'Gateway type',
    type: 'enum',
    defVal: 'event',
    enumList: [
      { val: 'event', dispName: 'Event-based' },
...
mxShapeBpmnGateway.prototype.paintVertexShape = function (c, x, y, w, h) {
  ...
  if (gwType === 'event' && outline !== null && outline !== 'none') {
    mxShapeBpmnEvent.prototype.strictDrawShape.call(
      this,
      c,
      (w - symbolW) * 0.5,
      (h - symbolH) * 0.5,
...
mxShapeBpmn2Task.prototype.customProperties = [
  ...
  {
    name: 'taskMarker',
    dispName: 'Task Marker',
    defVal: 'abstract',
    type: 'enum',
    enumList: [
      { val: 'abstract', dispName: 'Abstract' },
...
mxShapeBpmn2Task.prototype.customProperties = mxShapeBpmn2Task.prototype.customProperties.concat(
  mxShapeBpmnEvent.prototype.customProperties
)
mxShapeBpmn2Task.prototype.customProperties = mxShapeBpmn2Task.prototype.customProperties.concat(
  mxCellRenderer.prototype.getShape('mxgraph.basic.rect').prototype.customProperties
)
...
mxShapeBpmn2Data.prototype.customProperties = [
  {
    name: 'bpmnTransferType',
    dispName: 'Transfer Type',
    defVal: 'none',
    type: 'enum',
    enumList: [
      { val: 'none', dispName: 'None' },
...
mxShapeBpmn2Conversation.prototype.customProperties = [
  {
    name: 'bpmnConversationType',
    dispName: 'Type',
    defVal: 'conv',
    type: 'enum',
    enumList: [
      { val: 'conv', dispName: 'Conversation' },
      { val: 'call', dispName: 'Call' }
    ]
  },
  { name: 'isLoopSub', dispName: 'Subprocess', type: 'bool' }
...
mxCellRenderer.registerShape(
  mxShapeBpmn2Conversation.prototype.cst.CONVERSATION,
  mxShapeBpmn2Conversation
)

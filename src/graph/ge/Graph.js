 ...
 */
export const createSvgImage = function (w, h, data, coordWidth, coordHeight) {
  var tmp = unescape(
    encodeURIComponent(
      svgDoctype +
...
HoverIcons.prototype.roundDrop = !mxClient.IS_SVG
  ...
  : createSvgImage(26, 26, '<circle cx="13" cy="13" r="12" ' + 'stroke="#fff" fill="' + HoverIcons.prototype.arrowFill + '"/>')

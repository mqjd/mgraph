...
import markdownRender from './mxMarkdownRender'
...
mxCellRenderer.prototype.redrawLabel = function (state, forced) {
  ...
  if (
    state.text != null &&
    (state.text.wrap != wrapping || state.text.clipped != clipping || state.text.overflow != overflow || state.text.dialect != dialect)
  ) {
    state.text.destroy()
    state.text = null
  }

...
mxConnector.prototype.paintEdgeShape = function (c, pts) {
  ...
  if (sourceMarker != null) {
    c.setFillColor(mxUtils.getValue(this.style, mxConstants.STYLE_STARTFILLCOLOR, this.stroke))
    sourceMarker()
  }

  if (targetMarker != null) {
    c.setFillColor(mxUtils.getValue(this.style, mxConstants.STYLE_ENDFILLCOLOR, this.stroke))
    targetMarker()
  }
}

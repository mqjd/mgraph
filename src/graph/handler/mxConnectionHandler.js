...
mxConnectionHandler.prototype.isInsertBefore = function (edge, source, target, evt, dropTarget) {
  return this.insertBeforeSource && source != target && this.graph.model.getParent(edge) == this.graph.model.getParent(source)
}
...
mxConnectionHandler.prototype.createShape = function () {
  ...
  var shape =
    this.livePreview && this.edgeState != null ? this.graph.cellRenderer.createShape(this.edgeState) : new mxPolyline([], mxConstants.INVALID_COLOR)
...
mxConnectionHandler.prototype.createMarker = function () {
  ...
  marker.getCell = mxUtils.bind(this, function (me) {
    ...
    if (
      (this.graph.isSwimlane(cell) && this.currentPoint != null && this.graph.hitsSwimlaneContent(cell, this.currentPoint.x, this.currentPoint.y)) ||
...
mxConnectionHandler.prototype.mouseMove = function (sender, me) {
  if (!me.isConsumed() && (this.ignoreMouseDown || this.first != null || !this.graph.isMouseDown)) {
    ...
    if (this.first != null) {
      ...
      } else if (this.previous != null && mxEvent.isShiftDown(me.getEvent()) && !this.graph.isIgnoreTerminalEvent(me.getEvent())) {
...
mxConnectionHandler.prototype.connect = function (source, target, evt, dropTarget) {
  if (target != null || this.isCreateTarget(evt) || this.graph.allowDanglingEdges) {
    ...
    try {
      ...
      if (refParent != null && !model.isEdge(refParent) && refParent != model.getRoot()) {
        parent = refParent
      }
      ...
      if (edge != null) {
        ...
        if (
          ...
          (this.constraintHandler.currentConstraint == null || this.constraintHandler.currentConstraint.perimeter)
        ) {
          var tmp = source

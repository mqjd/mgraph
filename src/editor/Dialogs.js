...
var ColorDialog = function (editorUi, color, apply, cancelFn, defaultColor, defaultColorValue) {
  ...
  mxEvent.addListener(input, 'change', function () {
    ...
    input.value = validateColorName(value, false, defaultColorLabel)
    selectInput()
  })
...
var LayersWindow = function (editorUi, x, y, w, h) {
  ...
  function refresh() {
    ...
    function addLayer(index, label, child, defaultParent) {
      ...
      ldiv.style.display = 'block'
      ldiv.style.backgroundColor = Editor.isDarkMode() ? Editor.darkColor : 'whiteSmoke'
      ...
      inp.setAttribute('title', mxResources.get(graph.model.isVisible(child) ? 'hide' : 'show'))
